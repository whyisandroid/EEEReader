...
import com.ereader.client.ui.adapter.Notice2Adapter;
...
// for  公告
public class Notice2Activity extends BaseActivity implements OnClickListener , PullToRefreshView.OnHeaderRefreshListener, PullToRefreshView.OnFooterRefreshListener {
	...
	private Page page;
	private Notice2Adapter adapter;
		...
		public void handleMessage(android.os.Message msg) {
			switch (msg.what) {
				...
				case REFRESH_DOWN_OK:
					ToastUtil.showToast(Notice2Activity.this, "刷新成功！", ToastUtil.LENGTH_LONG);
					pull_refresh_book.onHeaderRefreshComplete();
					break;
				case REFRESH_UP_OK:
					adapter.notifyDataSetChanged();
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.more_notice2_layout);
	...
	private void initView() {
		...
		mList.clear();
		adapter = new Notice2Adapter(this,mList);
	...
	private OnItemClickListener noticeItemListener = new OnItemClickListener() {
		...
		public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				long arg3) {
			Notice notice = mList.get(arg2);
			Bundle bundle = new Bundle();
			bundle.putString("title", notice.getTitle());
			bundle.putString("url",notice.getUrl());
			IntentUtil.intent(Notice2Activity.this,bundle,WebActivity.class,false);
		}
	};
	...
	public void onFooterRefresh(PullToRefreshView view) {
		...
		mPageRq.setPer_page(15);
		if(page.getCurrent_page() == page.getLast_page()){
			ToastUtil.showToast(Notice2Activity.this,"没有更多了",ToastUtil.LENGTH_LONG);
			pull_refresh_book.onFooterRefreshComplete();
			return;
		}
	...
	private void getDate(final PageRq pageRq) {
		new Thread(new Runnable() {
			@Override
			public void run() {
				controller.getNotice(mhandler,pageRq);
			}
		}).start();
	}
}
