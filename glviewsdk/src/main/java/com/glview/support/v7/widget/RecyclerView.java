...
public class RecyclerView extends ViewGroup {
    ...
    public static abstract class LayoutManager {
         ...
         * will want to use {@link #detachAndScrapView(android.view.View, Recycler)}
         ...
         * {@link #attachView(android.view.View, int, LayoutParams) reattach}
         ...
         * {@link #detachAndScrapView(android.view.View, Recycler)}  scrapped}.
         *
    ...
    public static abstract class SmoothScroller {
         ...
         * {@link #onTargetFound(android.view.View, State, Action)} or
